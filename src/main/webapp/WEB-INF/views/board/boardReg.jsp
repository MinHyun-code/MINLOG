					...
					<div style="width: 100%; padding-top: 55.11%; position: relative;">
						<div style="width: 100%; height: 100%; position: absolute; left: 0px; top: 0px;">
							<div class="div-write5">
								...
								<input type="hidden" id="thumbnail_img_data"/>
							</div>
						</div>
					</div>
